...
from wtforms import TextField, PasswordField, SelectField, BooleanField, validators, DateField
...
class RegisterForm(FlaskForm):
    ...
    password = PasswordField(validators=[InputRequired(), Length(min=6, message='Passowrd too short')])
